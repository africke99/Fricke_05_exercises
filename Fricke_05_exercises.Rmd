...
```{r, echo=FALSE}}
knitr::include_graphics("trains_animate.gif")
```
...
```{r, echo=FALSE}}
knitr::include_graphics("tomato_animate.gif")
```
...
**I definitely prefer this to the static map because it evokes the sense of the bike journey! I tried to add purple points where speed exceeded 50mph but I don't know how to separate them from the animated path, I tried putting it in different spots in the code and the animation call animates everything no matter what.**
  

```{r, eval=FALSE}
fast <- mallorca_bike_day7 %>% 
  group_by(lon, lat, speed) %>% 
  filter(speed > "50.00000")
...
```{r, echo=FALSE}}
knitr::include_graphics("cases_animate.gif")
```
